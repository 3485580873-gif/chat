...
const loadData = async () => {
    try {
        ...
        const savedKaomojiLibrary = getVal(22);
        const savedKaomojiGroups = getVal(23);
        ...
        window.transferData = transferData;  // 暴露给red-packet.js
        // 颜文字库
        if (savedKaomojiLibrary && Array.isArray(savedKaomojiLibrary)) kaomojiLibrary = savedKaomojiLibrary;
