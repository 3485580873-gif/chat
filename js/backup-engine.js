...
(function (global) {
    ...
    function buildModuleSkipPatterns(flags) {
        ...
        if (!flags.inclQuestionnaire) p.push('dreamQuestionnaires');
        if (!flags.inclCompanion) p.push('companionDiary', 'companionSettings', 'companionState');
        return p;
    }
    ...
    /**
        ...
        flags = flags || {
            ...
            inclQuestionnaire: true, inclCompanion: true
        };
        var lfData = {};
